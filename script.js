...
link.addEventListener("input",function(){ document.querySelectorAll("a")[0].style.color=document.querySelectorAll("a")[2].style.color=document.querySelectorAll("a")[1].style.color=document.querySelectorAll("a")[3].style.color=document.querySelectorAll("a")[4].style.color=link.value;
...
bc1.addEventListener("input",function(){
  ...
  document.querySelector('.oval.fill').style.backgroundColor=bc1.value;
  document.querySelector ('.oval').style.borderColor=bc1.value;
  document.getElementsByClassName("color")[0].style.borderColor=document.getElementsByClassName("color")[1].style.borderColor=document.getElementsByClassName("color")[2].style.borderColor=bc1.value;
  document.getElementsByClassName("color")[3].style.borderColor=document.getElementsByClassName("color")[4].style.borderColor=document.getElementsByClassName("color")[5].style.borderColor=bc1.value;
